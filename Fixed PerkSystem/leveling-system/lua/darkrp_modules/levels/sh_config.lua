...
LevelSystemConfiguration.NPCXPAmount = 1000 -- Amount of XP to give when an NPC is killed

//Timer settings
LevelSystemConfiguration.TimerModule = true -- Give XP to everybody every howeverlong
LevelSystemConfiguration.Timertime = 50 -- How much time (in seconds) until everybody gets given XP
LevelSystemConfiguration.TimerXPAmount = 100 -- How much XP to give each time it goes off
LevelSystemConfiguration.TimerXPAmountVip = 2000 -- How much XP to give for vip players each time it goes off
LevelSystemConfiguration.TimerXPVipGroups = {"vip", "dev", "vip+", "tstaff_vip", "tstaff_vip+"} -- The vip groups

//XP settings
LevelSystemConfiguration.XPMult = 1 -- How hard it is to level up. 2 would require twice as much XP, ect.
LevelSystemConfiguration.MaxLevel = 50 -- The max level
